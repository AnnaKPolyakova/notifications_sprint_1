# Generated by Django 3.2 on 2023-06-16 22:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('mail', 'mail'), ('telegram', 'telegram')], help_text='Select notification type', max_length=40, verbose_name='notification_type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.CharField(blank=True, help_text='Contact for sending notifications', max_length=100, null=True, verbose_name='Contact for sending notifications')),
                ...
                ('is_correct_contacts', models.BooleanField(default=True, verbose_name='Field shows whether the contact details are correct')),
